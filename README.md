...
```sh
git clone https://github.com/CristianoFIlho/atividade-IA.git
```
...
[hhttps://github.com/CristianoFIlho/atividade-IA.git](https://github.com/CristianoFIlho/atividade-IA.git)

## 🧙‍♂️ Contribution

1. Make the _fork_ of the project (<https://github.com/CristianoFIlho/atividade-IA.git/fork>)
